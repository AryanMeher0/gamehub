...
export const BOARD: BoardSpace[] = [
  ...
  { index: 15, name: "Western RR",      type: "railroad", price: 200, rent: 25 },
  { index: 16, name: "Hyderabad",       type: "property", color: "orange",    price: 180, rent: 14  },
  { index: 17, name: "Jan Kalyan",       type: "community" },
  ...
  { index: 21, name: "Bangalore",       type: "property", color: "red",       price: 220, rent: 18  },
  { index: 22, name: "Lucky Draw",       type: "chance" },
  { index: 23, name: "Connaught Pl.",   type: "property", color: "red",       price: 220, rent: 18  },
  { index: 24, name: "Marine Drive",    type: "property", color: "red",       price: 240, rent: 20  },
  { index: 25, name: "Southern RR",     type: "railroad", price: 200, rent: 25 },
  { index: 26, name: "Gurgaon",         type: "property", color: "yellow",    price: 260, rent: 22  },
  { index: 27, name: "Noida Sec 18",    type: "property", color: "yellow",    price: 260, rent: 22  },
  ...
  { index: 31, name: "Mumbai Cntrl",    type: "property", color: "green",     price: 300, rent: 26  },
  { index: 32, name: "Gateway",         type: "property", color: "green",     price: 300, rent: 26  },
  { index: 33, name: "Jan Kalyan",      type: "community" },
  { index: 34, name: "BKC",            type: "property", color: "green",     price: 320, rent: 28  },
  { index: 35, name: "Eastern RR",      type: "railroad", price: 200, rent: 25 },
  { index: 36, name: "Lucky Draw",       type: "chance" },
  { index: 37, name: "Rashtrapati",     type: "property", color: "darkblue",  price: 350, rent: 35  },
  { index: 38, name: "GST",            type: "tax",      tax: 100 },
  { index: 39, name: "Taj Mahal",       type: "property", color: "darkblue",  price: 400, rent: 50  },
];

// Full property names (used in detail drawer, trade modal, etc.)
export const FULL_NAMES: Record<number, string> = {
  ...
  18: "Chennai",
  19: "Kolkata",
  21: "Bangalore Tech Park",
  23: "Connaught Place",
  24: "Marine Drive",
  26: "Gurgaon Cyber City",
  27: "Noida Sector 18",
  29: "Hitech City",
  31: "Mumbai Central",
  32: "Gateway of India",
...
// Rent table: spaceIndex → [base, 1H, 2H, 3H, 4H, hotel]
...
// Color group members (space indices)
