...
export const BOARD: BoardSpace[] = [
  ...
  { index: 1,  name: "Mediterranean",         type: "property", color: "brown",     price: 60,  rent: 2   },
  ...
  { index: 5,  name: "Reading RR",            type: "railroad", price: 200, rent: 25 },
  ...
  { index: 9,  name: "Connecticut",           type: "property", color: "lightblue", price: 120, rent: 8   },
  { index: 10, name: "Jail",                  type: "visiting" },
  { index: 11, name: "St. Charles",           type: "property", color: "pink",      price: 140, rent: 10  },
  { index: 12, name: "Electric Co.",          type: "utility",  price: 150, rent: 25 },
  ...
  { index: 15, name: "Penn. Railroad",        type: "railroad", price: 200, rent: 25 },
  { index: 16, name: "St. James",             type: "property", color: "orange",    price: 180, rent: 14  },
  { index: 17, name: "Comm. Chest",           type: "community" },
  { index: 18, name: "Tennessee",             type: "property", color: "orange",    price: 180, rent: 14  },
  ...
  { index: 32, name: "N. Carolina",           type: "property", color: "green",     price: 300, rent: 26  },
  { index: 33, name: "Comm. Chest",           type: "community" },
  { index: 34, name: "Penn. Ave",             type: "property", color: "green",     price: 320, rent: 28  },
  { index: 35, name: "Short Line RR",         type: "railroad", price: 200, rent: 25 },
