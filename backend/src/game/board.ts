...
export const BOARD: BoardSpace[] = [
  ...
  { index: 1,  name: "Mediterranean Ave",     type: "property", color: "brown",     price: 60 },
  ...
  { index: 9,  name: "Connecticut Ave",       type: "property", color: "lightblue", price: 120 },
  ...
  { index: 18, name: "Tennessee Ave",         type: "property", color: "orange",    price: 180 },
  ...
  { index: 32, name: "North Carolina Ave",    type: "property", color: "green",     price: 300 },
  { index: 33, name: "Community Chest",       type: "community" },
  { index: 34, name: "Pennsylvania Ave",      type: "property", color: "green",     price: 320 },
